  ...
  return (
    <div className='bg-gray-800 min-h-screen text-white '>
      ...
      <>
        ...
        {nfts.length == 1 ? <p className="text-center text-3xl">Good job!. There's a lot more <Link href="/" className="underline hover:no-underline text-amber-400">to win</Link> </p> : null}
